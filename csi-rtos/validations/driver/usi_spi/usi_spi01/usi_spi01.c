...
#define test_spi                        test_usi_spi
#define at25flash_read_data             usi_at25flash_read_data
#define at25flash_read_id               usi_at25flash_read_id
#define at25flash_erase_sector          usi_at25flash_erase_sector
#define at25flash_erase_chip            usi_at25flash_erase_chip
#define at25flash_program_data          usi_at25flash_program_data
...
#define TEST_SPI_IDX                    TEST_USI_SPI_IDX
#define TEST_PIN_SPI_MISO            TEST_PIN_USI_SPI_MISO
#define TEST_PIN_SPI_MOSI            TEST_PIN_USI_SPI_MOSI
#define TEST_PIN_SPI_CS              TEST_PIN_USI_SPI_CS
#define TEST_PIN_SPI_SCK             TEST_PIN_USI_SPI_SCK
#define TEST_PIN_SPI_MISO_FUNC       TEST_PIN_USI_SPI_MISO_FUNC
#define TEST_PIN_SPI_MOSI_FUNC       TEST_PIN_USI_SPI_MOSI_FUNC
#define TEST_PIN_SPI_CS_FUNC         TEST_PIN_USI_SPI_CS_FUNC
#define TEST_PIN_SPI_SCK_FUNC        TEST_PIN_USI_SPI_SCK_FUNC

#include "../../spi/spi01/w25q64fv.c"
#include "../../spi/spi01/spi.c"
