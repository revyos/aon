...
int8_t iis_DmaSend_test(void)
{
    i2s_handle_t iis_0;
    int32_t r_value;
    uint8_t i, tc_num;

    uint32_t send_data[] = {1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 11, 12, 13, 14, 15, 16};
    ...
    for (i = 0; i < tc_num; i++) {
        r_value = csi_i2s_dma_send(tc[i].handle, tc[i].data, tc[i].data_size);
