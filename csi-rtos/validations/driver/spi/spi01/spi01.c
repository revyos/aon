...
{
    csi_pin_set_mux(TEST_PIN_SPI_MISO, TEST_PIN_SPI_MISO_FUNC);
    csi_pin_set_mux(TEST_PIN_SPI_MOSI, TEST_PIN_SPI_MOSI_FUNC);
    csi_pin_set_mux(TEST_PIN_SPI_CS, TEST_PIN_SPI_CS_FUNC);
    csi_pin_set_mux(TEST_PIN_SPI_SCK, TEST_PIN_SPI_SCK_FUNC);
}
