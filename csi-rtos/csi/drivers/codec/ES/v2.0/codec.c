...
csi_error_t csi_codec_input_analog_gain(csi_codec_input_t *ch, uint32_t val)
{
    ...
    */
    ...
    if (ch->ch_idx <= 2) {
        ret = es7210_mic1_set_gain(&es7210_dev0, val);
        ret = es7210_mic2_set_gain(&es7210_dev0, val);
    } else {
        ret = es7210_mic1_set_gain(&es7210_dev1, val);
        ret = es7210_mic2_set_gain(&es7210_dev1, val);
    }
