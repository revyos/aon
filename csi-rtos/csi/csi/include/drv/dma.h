...
typedef struct {
    ...
    uint8_t                     cyclic_en;        ///< 1:dma enable cyclic mode, 0: disable
    csi_dma_cyclic_config_t     cyclic_config;    ///< cyclic config
...
struct csi_dma_ch {
    ...
    void                     *arg;
    int16_t                  etb_ch_id;
    csi_dma_cyclic_state_t   cyclic_state;
