...
#if (defined CONFIG_SYSLOG_LEVEL_DEBUG)
#define LOG_LEVEL 3
#endif

#if (defined CONFIG_SYSLOG_LEVEL_INFO)
#define LOG_LEVEL 2
#endif

#if (defined CONFIG_SYSLOG_LEVEL_WARN)
#define LOG_LEVEL 1
#endif

#if (defined CONFIG_SYSLOG_LEVEL_ERROR)
#define LOG_LEVEL 0
#endif
